...
회사에 입사 하고, 적응하고, 프로젝트도 수행하느라 정말 오랜만에 블로그에 글을 남긴다. 앞으로 매일 소소하게나마 알게된, 습득한, 공부한 내용을 기록하고자 한다.
...
- 회사에 입사하고 난 후, 여러명이 하나의 프로젝트에 투입되었는데 단순히 `git merge`만 사용할 경우, 여러 문제점이 유발될 수 있음을 인식하게 되었다.
  ...
  (복잡하게 커밋그래프가 얽혀있는 모습)
- 커밋 그래프가 얽혀있어 변경 사항을 파악하기 힘듦
- 상대방이 작업하여 커밋한 결과물에 나의 커밋이 달라붙어 얽혀있는(...) 모습
  <br/>

![down.png.png](down.png.png)
극단적으로, Merge만 할 경우, 엄청나게 복잡한 커밋 히스토리가 생성될 수 있다.
...
나와 상대방이 동시에 작업을 했고, 상대방이 먼저 커밋을 했다면, 상대방의 새로운 커밋을 base로 하는 방식으로 병합 시, conflict 없이 나의 작업물을 반영할 수 있다.

![updated.png](updated.png)

- 회사에서 진행중인 프로젝트의 커밋 그래프
